...
struct BSTextureManager {
	...
	struct TextureLists {
		NiTPointerList<BSRenderedTexture*> kShadowMaps;
		NiTPointerList<BSRenderedTexture*> kWaterDepthMaps;
		NiTPointerList<BSRenderedTexture*> kWaterReflectionMaps;
		NiTPointerList<BSRenderedTexture*> kWaterBlurMaps;
		NiTPointerList<BSRenderedTexture*> kWaterNoiseMaps;
	};
	

	TextureLists							kFreeTextures;
	TextureLists							kActiveTextures;
	NiTPointerList<RenderedTextureData*>	lTextureLists[2]; // These two should be separate, figure out later what's the diff
	NiTPointerList<BSRenderedTexture*>		ShadowMapList[2];
	...
	void RetireTexture(BSRenderedTexture* apRenderedTexture);
	...
	static NiTexture* GetDebugMipmapsTexture();
};
