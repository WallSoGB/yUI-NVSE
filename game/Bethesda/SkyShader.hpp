...
public:
	...
	static void __fastcall SetRenderPassEx(SkyShader* apThis, void*, RenderPassTypes aeRenderPass);
	...
	static NiD3DPass* PickPass(RenderPassTypes aeRenderPass, SkyShader* apShader = nullptr);
