...
public:
	...
	static void __fastcall SetRenderPassEx(TallGrassShader* apThis, void*, RenderPassTypes aeRenderPass);
	...
	void SetupInstanceSize(TallGrassShaderProperty* apShaderProperty);

	static TallGrassShader* GetShader();
	static NiD3DPass* PickPass(RenderPassTypes aeRenderPass, TallGrassShader* apShader = nullptr);
