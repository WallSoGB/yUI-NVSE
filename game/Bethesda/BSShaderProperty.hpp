...
public:
	...
	struct RenderPassList : public NiTArray<BSRenderPass*> {
		...
		void AddPass(NiGeometry* apGeometry, RenderPassTypes auiPassEnum, bool abEnable,
			UInt8 aucNumLights, ShadowSceneLight* apSceneLight, ShadowSceneLight* apSceneLight1, ShadowSceneLight* apSceneLight2, BSRenderPass* apRenderPass);

		static void __fastcall AddPass_Hook(RenderPassList* apThis, void*, NiGeometry* apGeometry, RenderPassTypes auiPassEnum, bool abEnable,
			UInt8 aucNumLights, ShadowSceneLight* apSceneLight, ShadowSceneLight* apSceneLight1, ShadowSceneLight* apSceneLight2, BSRenderPass* apRenderPass);
	};
	...
	BSShaderManager::eShader			uiShaderIndex;
	float								fDepthBias;
