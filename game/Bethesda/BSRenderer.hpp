...
public:
	...
	static void __fastcall DrawIndexedPrimitive(NiDX9Renderer* apRenderer, void*, NiGeometryBufferData* apBuffData, const NiSkinPartition::Partition* apSkinPartition, NiGeometryData* apGeoData);
