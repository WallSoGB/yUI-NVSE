...
namespace BSTestObjects {
	NiLines* MakeLine(const NiPoint3* apStart, const NiColorA& apStartColor, const NiPoint3* apEnd, const NiColorA& apEndColor, bool abUseShader = true);
	NiTriShape* MakeSquare(float afScale, const NiColorA& apColor, bool abUseShader = true);
	...
	NiLines* MakeDirArrow(NiPoint3* apDirection, const NiColorA& apColor, bool abUseShader = true);
