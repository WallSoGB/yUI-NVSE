...
public:
	...
	static void __fastcall SetRenderPassEx(SkinShader* apThis, void*, RenderPassTypes aeRenderPass);
	static void __fastcall Func_62Ex(SkinShader* apThis, void*, RenderPassTypes aeRenderPass);
