...
#include "ImageSpaceEffectRadialBlur.hpp"
...
public:
	...
	void RenderEffectRange(NiDX9Renderer* apRenderer, BSRenderedTexture** appSourceTarget, BSRenderedTexture** appDestTarget);
