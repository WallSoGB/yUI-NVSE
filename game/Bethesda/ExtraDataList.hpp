...
struct BaseExtraList 
{
	...
	__forceinline bool			HasType(BSExtraData::EnumType aeType) const { return ThisStdCall<bool>(0x40FE80, this, aeType); };
	__forceinline UInt32		SetHasType(BSExtraData::EnumType aeType, bool abCleared) { return ThisStdCall<UInt32>(0x40FEE0, this, aeType, abCleared); };
	...
	__forceinline void			RemoveExtra(BSExtraData::EnumType aeType) { ThisStdCall(0x410140, this, aeType); }
	// called GetExtraData but it's the only one where BSExtraData isn't shortened to Extra
	__forceinline BSExtraData*	GetExtra(BSExtraData::EnumType aeType) const { return ThisStdCall<BSExtraData*>(0x410220, this, aeType); }
	__forceinline BSExtraData*	GetPrevExtra(BSExtraData::EnumType aeType) const { return ThisStdCall<BSExtraData*>(0x4102D0, this, aeType); }
	...
	union
	{
		...
		struct
		{
			enum EnumJIPExtraListFlags : UInt8
			{
			...
			EnumJIPExtraListFlags eJIPFlags;
