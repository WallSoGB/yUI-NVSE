...
public:
	...
	virtual void						SetPixelShader(NiD3DPixelShaderHandle hShader, bool bSave);
	virtual NiD3DPixelShaderHandle		GetPixelShader();
	virtual void						RestorePixelShader();
	virtual void						ClearPixelShader(NiD3DPixelShaderHandle hShader);
	virtual void						SetVertexShader(NiD3DVertexShaderHandle hShader, bool bSave);
	virtual NiD3DVertexShaderHandle		GetVertexShader();
	...
	virtual void						SetDeclaration(NiD3DVertexDeclaration hDeclaration, bool bSave);
	virtual NiD3DVertexDeclaration		GetDeclaration();
	...
	// Do Not Use
	virtual void						vSetTexture(UInt32 uiStage, D3DBaseTexturePtr pkTexture); 
	// Do Not Use
	virtual D3DBaseTexturePtr			vGetTexture(UInt32 uiStage);
	...
	D3DBaseTexturePtr				m_apkTextureStageTextures[16];
	...
	void				SetTexture(UInt32 uiStage, D3DBaseTexturePtr pkTexture);
	D3DBaseTexturePtr	GetTexture(UInt32 uiStage);
